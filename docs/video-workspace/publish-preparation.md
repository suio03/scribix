...
2026-09-08：本地实现，尚未部署。产品范围见[首期产品计划](../research/2026-09-08-phase-one-publish-kit-product-plan.md)。登录后的真实上传全流程和无指导新手任务仍待验收；以下测试不能替代这两项。
...
- 每个分析批次及完整性复审接收同一条件，同时要求原文支持、主题和类型匹配、独立完整及 15–45 秒。允许不足数量或零结果，不回退到无条件推荐。理由在卡片显示，评分不展示。

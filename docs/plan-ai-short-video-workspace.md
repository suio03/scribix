...
- “音效”在 V1 是仅指音量、响度标准化、降噪、淡入淡出等音频处理，还是包括背景音乐和可放置在时间线上的音效素材。建议 V1 只做前者。
- 原视频按套餐保留多久。当前代码对 completed transcript 的媒体统一保留约 14 天；新产品应明确免费/付费 retention 和重新渲染规则。
...
- [ ] 收集 candidate 接受率、编辑时间、render 成功率和下载率。

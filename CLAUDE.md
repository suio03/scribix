...
Start with [docs/README.md](docs/README.md) for current contracts, operations, research, and future proposals. `docs/archive/` preserves historical plans and design studies; its checkboxes and deployment statements are not current evidence. Ask AI behavior and outstanding smoke checks live in `docs/transcript-ask-ai.md`; video contracts and external release checks live in `docs/video-workspace/`. Collections and Ask AI v2 remain proposals in `docs/roadmap/collections-transcript-ai.md`.

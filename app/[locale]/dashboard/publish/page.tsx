...
export default async function Page() {
 ...
 return <SocialAccessGate session={session} view="posts"><PublishingWorkspace allowDemo={/^(localhost|127\.0\.0\.1)(:\d+)?$/.test(host)} userId={session.user.id} view="compose" /></SocialAccessGate>;
}

    ...
    >
      <div className="w-full max-w-[560px] rounded-2xl border border-line bg-paper p-5 shadow-[0_30px_80px_-35px_rgba(14,13,11,0.45)]">
        <div className="flex items-start justify-between gap-4">
          <div>
            <h2 id="paid-feature-upgrade-title" className="text-[21px] font-semibold tracking-tight text-ink">
              {isSummary
                ? safeT(t, "upgradeSummaryModalTitle", "Summarize this transcript")
                : safeT(t, "upgradeTranslationModalTitle", "Translate this transcript")}
            </h2>

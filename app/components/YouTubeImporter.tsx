        ...
        <div className="mt-5 rounded-xl border border-line bg-paper/80 p-4">
          <div className="flex items-start gap-2">
            ...
            <div className="min-w-0">
              ...
              <p className="mt-0.5 text-[12px] text-ink/55">{t("tracksFound", { count: result.tracks.length })}</p>
            </div>
          </div>
...
function trackLabel(track: YouTubeTrack, t: ReturnType<typeof useTranslations<"Dashboard.youtube">>): string {

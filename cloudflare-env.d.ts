/* eslint-disable */
// Generated by Wrangler by running `wrangler types --strict-vars=false --env-interface=CloudflareEnv cloudflare-env.d.ts` (hash: 30b4600d79630450f2b69b8873f3834f)
// Runtime types generated with workerd@1.20260701.1 2025-03-01 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
	SCRIBIX_MEDIA: R2Bucket;
	DB: D1Database;
	AI_CLIPS_QUEUE: Queue;
	VIDEO_RENDER_QUEUE: Queue;
	ASSETS: Fetcher;
	AI_CLIPS_BATCH_ENABLED: string;
	CLIPFLIGHT_TIKTOK_PUBLISH_ENABLED: string;
	VIDEO_WORKSPACE_ROLLOUT_PERCENT: string;
	VIDEO_WORKSPACE_PILOT_USER_IDS: string;
	...
	PADDLE_BASIC_MONTHLY_PRICE_ID: string;
	PADDLE_BASIC_YEARLY_PRICE_ID: string;
	PADDLE_PRO_MONTHLY_PRICE_ID: string;
	PADDLE_PRO_YEARLY_PRICE_ID: string;
	PADDLE_HISTORICAL_PRO_MONTHLY_PRICE_ID: string;
	PADDLE_HISTORICAL_PRO_YEARLY_PRICE_ID: string;
	PADDLE_V2_STARTER_MONTHLY_PRICE_ID: string;
	PADDLE_V2_STARTER_YEARLY_PRICE_ID: string;
	PADDLE_V2_PRO_MONTHLY_PRICE_ID: string;
	PADDLE_V2_PRO_YEARLY_PRICE_ID: string;
	PADDLE_V2_CHECKOUT_ENABLED: string;

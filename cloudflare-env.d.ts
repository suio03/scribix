/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: ec3c97f5c37c2edbda3e8dcfceed28b5)
// Runtime types generated with workerd@1.20260426.1 2025-03-01 global_fetch_strictly_public,nodejs_compat
declare namespace Cloudflare {
	...
	interface Env {
		...
		EDGE_EXTENSION_ID: "nojojdfhlbfklhjekkbpccnoclogacfn";
		YOUTUBE_CAPTION_SERVICE_URL: "https://yt-caption.scribix.io";
		NEXT_PUBLIC_PADDLE_ENV: "sandbox" | "production";
		NEXT_PUBLIC_PADDLE_CLIENT_TOKEN: "live_7c94d1c1d9c14836a0180654f9f";
		NEXTAUTH_URL: string;
		AUTH_SECRET: string;
		GOOGLE_ID: string;
